(function(){function v(a){return new Promise(d=>setTimeout(d,a))}function P(a){if(H&&!q){let [d,f]=I(a.target);k[d][f].i=!0;l(d,f).classList.add("wall")}}function l(a,d){return document.getElementById("cell-"+a+"-"+d)}function Q(a){a=a.target;let [d,f]=I(a),b=k[d][f];if(!b.i&&!b.l&&b.m){for(let c=0;c<m;c++)for(let e=0;e<n;e++){let h=k[c][e],g=l(c,e);h.i||(h.s&&(h.s=!1,g.classList.remove("end")),h.path=!1,h.m=!1,h.g=0,g.textContent="",h.l||(g.style.backgroundColor="rgb(201, 201, 201, 0.4)"))}a.style.backgroundColor=
