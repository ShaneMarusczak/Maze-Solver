(function(){function q(a){return new Promise(b=>setTimeout(b,a))}function J(a){if(C){a=a.target;let [b,e]=[a.id.split("-")[1],a.id.split("-")[2]];h[b][e].m=!0;g(b,e).classList.add("wall")}}function g(a,b){return document.getElementById("cell-"+a+"-"+b)}function D(){E&&F&&(document.getElementById("start").removeEventListener("click",D),document.getElementById("start").disabled=!0,document.getElementById("visualization_mode").disabled=!0,document.getElementById("visualization_mode").classList.add("hidden"),
document.getElementById("vis_label").classList.add("hidden"),r=!0,K(G),k?q(m*n*2.5).then(()=>t(z)):t(z))}function t(a){a.path=!0;if(0!==a.g||a.l)a.l||(g(a.x,a.y).style.backgroundColor="cadetblue"),k?q(200).then(()=>t(a.o())):t(a.o())}function K(a){let b=1,e=new p;a.j=!0;for(e.s(a);!e.v();){b++;let d=e.u();for(let f of d.i){let c=h[f[0]][f[1]];if(2!==f[3]||!u(1,3,d))if(4!==f[3]||!u(3,5,d))if(6!==f[3]||!u(5,7,d))if(8!==f[3]||!u(7,1,d)){if(c.l)return;c.g>d.g+f[2]&&c.j&&(c.g=d.g+f[2],k&&q(3*b).then(()=>
{g(c.x,c.y).textContent=(d.g+f[2]).toString().substr(0,5)}));c.j||c.m||(c.j=!0,c.B=c.g,c.g=d.g+f[2],k&&q(2*b).then(()=>{g(c.x,c.y).textContent=(d.g+f[2]).toString().substr(0,5);g(c.x,c.y).style.backgroundColor="orange"}),g(c.x,c.y).style.fontSize="8px",e.s(c))}}}}function u(a,b,e){let d=null,f=null;for(let c of e.i)c[3]===a&&(d=h[c[0]][c[1]]),c[3]===b&&(f=h[c[0]][c[1]]);return null===d||null===f?!1:!(!d.m&&!f.m)}function L(a){!r&&v&&w&&!H&&(m=Number(x.value),n=Number(y.value),x.disabled=!0,y.disabled=
...
void 0===a.buttons?1===a.which:1===a.buttons}function M(){for(let a=0;a<n;a++){h.push([]);const b=document.createElement("div");b.id="col-"+a;b.classList.add("col");b.draggable=!1;b.h=function(){return!1};P.appendChild(b);for(let e=0;e<m;e++){const d=new Q(a,e);h[a].push(d);h[a][e].A();const f=document.createElement("div");f.id="cell-"+a+"-"+e;f.classList.add("cell");b.appendChild(f);f.addEventListener("click",()=>d.h())}}}let r=!1,v=!0,w=!0,H=!1,m=30,n=30,I=!0,B=!1,E=!1,F=!1,C=!1,k=!1,z,G;const h=
[],P=document.getElementById("gameBoard_UI"),x=document.getElementById("rowsInput"),y=document.getElementById("colsInput");class Q{constructor(a,b){this.x=a;this.y=b;this.i=[];this.l=this.path=this.m=!1;this.g=0;this.j=!1}A(){const a=[-1,0,1];for(let c of a)for(let l of a){var b=this.x+c,e=this.y+l;if(0<=b&&b<n&&0<=e&&e<m&&(0!==c||0!==l)){b=this.x;e=this.y;var d=this.x+c,f=this.y+l;b=d===b&&f<e?1:d>b&&f<e?2:d>b&&f===e?3:d>b&&f>e?4:d===b&&f>e?5:d<b&&f>e?6:d<b&&f===e?7:8;0===c||0===l?this.i.push([this.x+
c,this.y+l,1,b]):this.i.push([this.x+c,this.y+l,Math.sqrt(2),b])}}}o(){let a=Infinity,b=null;for(let e of this.i){let d=h[e[0]][e[1]];d.g<a&&d.j&&(a=d.g,b=d)}return b}h(){if(I&&!r)this.l=!0,g(this.x,this.y).classList.add("start"),z=this,I=!1,E=B=!0;else if(B&&!r){G=this;g(this.x,this.y).classList.add("end");B=!1;F=!0;for(let a=0;a<n;a++)for(let b=0;b<m;b++)g(a,b).addEventListener("mouseover",J)}}}(function(){document.getElementById("start").addEventListener("click",D);document.getElementById("buildGrid").addEventListener("click",
L);document.getElementById("visualization_mode").addEventListener("input",()=>{k=!k});k=document.getElementById("visualization_mode").checked;document.body.onmousedown=A;document.body.onmousemove=A;document.body.onmouseup=A;x.addEventListener("input",N);y.addEventListener("input",O);y.value="30";x.value="30";document.getElementById("start").disabled=!0})();class p{constructor(){this.h=[]}}p.prototype.s=function(a){this.h.push(a)};p.prototype.u=function(){return this.h.shift()};p.prototype.v=function(){return 0===
this.h.length};p.prototype.length=function(){return this.h.length}})();
