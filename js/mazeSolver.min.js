...
c.appendChild(d);d.addEventListener("click",()=>b.j());d.addEventListener("dblclick",()=>b.u());d.draggable=!1;d.j=function(){return!1}}}}let p=!1,O=!1,A=!0,B=!0,k=30,l=30,P=!0,H=!1,M=!1,N=!1,I=!1,m=!1,v=!1,y=!1,u,q;const g=[],G=document.getElementById("gameBoard_UI"),C=document.getElementById("rowsInput"),D=document.getElementById("colsInput");class X{constructor(a,c){this.x=a;this.y=c;this.g=[];this.l=this.s=this.path=this.h=!1;this.i=0;this.m=!1}A(){this.g=[];const a=[-1,0,1];for(let b of a)for(let d of a){var c=
this.x+b,e=this.y+d;0<=c&&c<l&&0<=e&&e<k&&(0!==b||0!==d)&&(c=0===b&&-1===d?"N":1===b&&-1===d?"NE":1===b&&0===d?"E":1===b&&1===d?"SE":0===b&&1===d?"S":-1===b&&1===d?"SW":-1===b&&0===d?"W":"NW",0===b||0===d?this.g.push({x:this.x+b,y:this.y+d,o:1,direction:c}):this.g.push({x:this.x+b,y:this.y+d,o:Math.sqrt(2),direction:c}))}}v(){let a=Infinity,c=null;for(let e of this.g){let b=g[e.x][e.y];b.i<a&&b.m&&!b.h&&(a=b.i,c=b)}return c}j(){if(P&&!p)this.s=!0,h(this.x,this.y).classList.add("start"),u=this,P=!1,
M=H=!0;else if(H&&!p){q=this;this.l=!0;h(this.x,this.y).classList.add("end");H=!1;N=!0;for(let a=0;a<l;a++)for(let c=0;c<k;c++)h(a,c).addEventListener("mouseover",Q)}}u(){if(!m){var a=h(this.x,this.y);if(this.h)this.h=!1,a.classList.remove("wall"),K(!0),this.l=!0,a.classList.add("end"),q=this,E(q),y&&r(u);else{this.h=!0;a.classList.add("wall");this.l=!1;a.classList.remove("end");let {x:c,y:e}=this.g.find(b=>g[b.x][b.y].path);g[c][e].path=!1;h(c,e).classList.remove("path");g[c][e].l=!0;h(c,e).classList.add("end")}}}}
(function(){document.getElementById("start").addEventListener("click",L);document.getElementById("buildGrid").addEventListener("click",T);document.getElementById("visualization_mode").addEventListener("input",()=>{m=!m});m=document.getElementById("visualization_mode").checked;document.getElementById("mouse_mode").addEventListener("input",()=>{(v=!v)?(document.getElementById("visualization_mode").disabled=!0,m=document.getElementById("visualization_mode").checked=!1):document.getElementById("visualization_mode").disabled=
!1});if(v=document.getElementById("mouse_mode").checked)document.getElementById("visualization_mode").disabled=!0,m=document.getElementById("visualization_mode").checked=!1;document.body.onmousedown=F;document.body.onmousemove=F;document.body.onmouseup=F;C.addEventListener("input",V);D.addEventListener("input",W);D.value="30";C.value="30";document.getElementById("start").disabled=!0;G.draggable=!1;G.j=function(){return!1}})();class w{constructor(){this.j=[]}}w.prototype.u=function(a){this.j.push(a)};
w.prototype.B=function(){return this.j.shift()};w.prototype.C=function(){return 0===this.j.length};w.prototype.length=function(){return this.j.length}})();
